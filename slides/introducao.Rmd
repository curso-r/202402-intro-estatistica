...
- O número de televisores numa casa (coletado pelo IBGE) é uma variável **discreta**. Variam sempre de 1 em 1: 0 televisores, 1 televisor, 2 televisores etc
...
O número de faixas no R básico é escolhido automaticamente com base em alguns critérios, sendo o básico construir $\log(n)$ faixas. Não vamos detalhar agora, mas isso quer dizer que o número de faixas é **muito** menor do que $n$
