---
title: "Teorema Central do Limite e consequências"
...
(3) Algumas estatísticas tem comportamento previsto por teoria matemática, a partir de certas hipóteses sabemos que se fossemos fazer um histograma de $\bar{X}$ em várias amostras o desenho é fixo:

```{r}
plot(seq(-2, 2, .01), dnorm(seq(-2, 2, .01)), type = 'l', xlab = "Possibilidades de X_barra", ylab = "Histograma teórico")
```
